    ...
    <section class="bg-white min-h-screen flex items-center">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h1 class="mb-4 tracking-tight font-extrabold text-9xl text-primary">4<BloodtypeIcon sx={{fontSize: '7rem'}} />4</h1>
                ...
                <Button variant="contained" style={{ backgroundColor: '#FF1C23' }} onClick={() => navigate('/')}>Back to Homepage</Button>
            </div>   
        </div>
    </section>
  )
