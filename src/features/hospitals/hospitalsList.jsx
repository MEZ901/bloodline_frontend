...
const HospitalsList = () => {
  ...
  return (
    <div className="relative flex items-center gap-5">
      ...
      <div ref={slider} className="w-full h-full flex items-center gap-5 overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide">
        {hospitals.map((hospital) => (
          <div key={hospital.id} className="min-w-min h-32 bg-primary p-5">
